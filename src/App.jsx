      ...
      <div className="app-container" style={{...S.app,background:K.bg}}>
        ...
        <div style={LP.hero}>
          <div style={LP.heroInner}>
            <div style={LP.badge}>Home Maintenance, Simplified</div>
            <h1 style={LP.heroTitle}>Your home,<br/><em style={{fontStyle:"italic",color:K.accent}}>handled.</em></h1>
            <p style={LP.heroSub}>Upkeep tracks every maintenance task, part, and due date across your entire home — so nothing falls through the cracks.</p>
        ...
        <div style={LP.section}>
          <div style={LP.sectionInner}>
            <h2 style={LP.sectionTitle}>The problem with homeownership</h2>
            <p style={LP.sectionText}>Your furnace filter should've been changed 3 months ago. The water heater anode rod? Who knows. The dryer vent hasn't been cleaned since you moved in. Most homeowners don't forget because they don't care — they forget because there's no system.</p>
          </div>
        </div>
          ...
          <div style={LP.sectionInner}>
            ...
            <div style={LP.featureGrid}>
              <div style={LP.featureCard}>
                ...
                <p style={LP.featureText}>HVAC, water heater, pool, boat, generator, vehicle, and more — each loaded with the right tasks, intervals, and parts.</p>
              </div>
              <div style={LP.featureCard}>
                <span style={LP.featureIcon}>⏰</span>
        ...
        <div style={LP.section}>
          <div style={LP.sectionInner}>
            ...
            <div style={LP.stepsRow}>
              <div style={LP.step}><div style={LP.stepNum}>1</div><h3 style={LP.stepTitle}>Pick your systems</h3><p style={LP.stepText}>Choose from 22 templates — furnace, pool, vehicle, boat, and more.</p></div>
        ...
        <div style={{...LP.section,background:"#1A1A1A",color:"#fff"}}>
          <div style={{...LP.sectionInner,textAlign:"center"}}>
            <h2 style={{...LP.sectionTitle,color:"#fff"}}>The average homeowner spends $3,000+/year on maintenance.</h2>
            <p style={{...LP.sectionText,color:"rgba(255,255,255,0.7)",maxWidth:500,margin:"0 auto"}}>Upkeep shows you exactly where that money goes — and helps you plan for it instead of getting surprised by it.</p>
          </div>
        </div>
        ...
        <div style={{...LP.section,paddingBottom:60}}>
          <div style={{...LP.sectionInner,textAlign:"center"}}>
            ...
            <p style={{...LP.sectionText,marginBottom:24}}>Set up your home in under 2 minutes. Free forever for a single property.</p>
        ...
        {/* Footer */}
        <div style={LP.footer}>
          <p style={LP.footerText}>Upkeep — Your home, handled.</p>
        </div>
      </div>
    );
  }
      ...
      <header style={S.header}>
        <div style={S.headerInner}>
          <div style={S.logoRow} onClick={()=>{setView("dashboard");setSelectedSystem(null);setListView(null);}}>
            ...
            <div><h1 style={S.logoTitle}>Upkeep</h1><p style={S.logoSub}>Home Maintenance</p></div>
          </div>
